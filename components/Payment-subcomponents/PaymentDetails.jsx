      ...
      <div className=" lg:p-[38px]  payment-insde  extrasmall:max-w-[300px]  pe-12 sm:ps-0 sm:me-0 sm:max-w-full">
        ...
        >
          ...
          <div className="mt-8">
            ...
            <div className="mt-4">
              ...
              <div className="mobile-phone-div flex flex-col  pt-5 pb-4">
                <input
                  ...
                  id="phone"
                  name="phone"
                  className="border ms-[17px] me-[17px] border-gray-300 max-w-[545px] in-p mobile-phone-input rounded-md pl-5"
              ...
              <div className="flex flex-wrap flex-col items-start justify-center mb-4 border border-gray-300 pt-[17px] rounded-md">
                ...
                <div className="mobile-phone-div flex flex-col bg-gray pt-5 pb-4 max-w-full">
                  <input
                    type="tel"
                    id="phone"
                    name="phone"
            ...
            <div className="mt-6 max-w-[300px] md:max-w-[500px]">
              <button
